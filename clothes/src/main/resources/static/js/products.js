...
function filterProducts() {
    ...
    fetch('/products', {
        ...
        .then(data => {
            ...
            const totalProductFilterInput = doc.querySelector('input.d-none');
            const totalProductElement = document.getElementById('totalProduct');
            if (totalProductFilterInput) {
                totalProductElement.innerText = `Sản phẩm: ${totalProductFilterInput.value}`;
            }
        })
